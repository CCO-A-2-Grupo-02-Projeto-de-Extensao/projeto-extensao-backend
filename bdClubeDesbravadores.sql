...
CREATE TABLE IF NOT EXISTS Pessoa (
    ...
    escola VARCHAR(150),
    serie_escolar VARCHAR(45),
    nome_responsavel1 VARCHAR(100),
    telefone_responsavel1 VARCHAR(20),
    rg_responsavel1 VARCHAR(20),
    cpf_responsavel1 VARCHAR(14),
    nome_responsavel2 VARCHAR(100),
    telefone_responsavel2 VARCHAR(20),
    rg_responsavel2 VARCHAR(20),
    cpf_responsavel2 VARCHAR(14),
